...
<body>
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <form action="<?= base_url() ?>laporan/buku_stok/print_laporan" method="POST" class="form-horizontal"
                        ...
                        <div class="form-group">
                          <div class="col-sm-1">
                            <label class="radio-inline">
                              <input type="radio" name="filter" value="hari" id="hari" class="styled"
                                checked="checked">
                              Hari
                            </label>
                          </div>
                          <div class="col-sm-1">
                            <label class="radio-inline">
                              <input type="radio" name="filter" value="bulan" id="bulan" class="styled">
                              Bulan
                            </label>
                          </div>
                          <div class="col-sm-1">
                            <label class="radio-inline">
                              <input type="radio" name="filter" value="tahun" id="tahun" class="styled">
                              Tahun
                            </label>
                          </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                              <select class="bootstrap-select" data-width="100%" name="bulan" id="bulan">
                                ...
                                for ($c = 0; $c < $jlh_bln; $c += 1) {
                                  ...
                                  ?>
                                  <option value="<?php echo $no_pas; ?>" <?php if ($no_pas == date('m')) {
                                       echo 'selected';
                                     }
                                     ; ?>> <?php echo $bulan[$c]; ?> </option>
                                  <?php
                                }
                                ?>
                              </select>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <select name="bulan_tahun" class="bootstrap-select" data-width="100%" id="bulan_tahun">
                                ...
                                for ($a = 2010; $a <= $now; $a++) {
                                  ?>
                                  <option value="<?php echo $a; ?>" <?php if ($a == date('Y')) {
                                       echo 'selected';
                                     }
                                     ; ?>><?php echo $a; ?></option>
                                  <?php
                    ...
                    <button class="btn btn-primary" type="submit"><i class="fa fa-search position-left"></i>
                      Cari</button>
  ...
  <script type="text/javascript">
    ...
    function export_excel() {
      ...
      let link = `<?php echo base_url('laporan/buku_stok/export_excel'); ?>?filter=${filter}&tgl_dari=${filter_dari}&tgl_sampai=${filter_sampai}&bulan=${filter_bulan}&bulan_tahun=${filter_bulantahun}&tahun=${filter_tahun}&id_cabang=${cabang}`;
