...
<div class="content">
			...
			<div class="panel panel-flat border-top-success border-top-lg">
				...
				<form action="<?= base_url() ?>laporan/penjualan_barang/print_laporan" method="POST" class="form-horizontal" target="_blank" autocomplete="off">
				<div class="row">
					<div class="col-sm-12">
					...
					<div class="col-sm-12">
					<div class="form-group">
						<label class="control-label col-sm-1"><b>Pilih Menu Penjualan</b></label>
						<div class="col-sm-5">
						<select class="bootstrap-select" data-width="100%" name="penjualan" id="penjualan">
							<option value="Anda Belum Memilih Menu Penjualan">-- Pilih --</option>
							<option value="Terbanyak">Penjualan Terbanyak</option>
							<option value="Terendah">Penjualan Terendah</option>
...
<script type="text/javascript">
  ...
  $('#filter_tahun').click(function(){
	...
	function export_excel() {
		...
		let filter_penjualan = $('#penjualan').val();
		
		console.log(filter_sampai);
		let link = `<?php echo base_url('laporan/penjualan_barang/export_excel'); ?>?filter=${filter}&tgl_dari=${filter_dari}&tgl_sampai=${filter_sampai}&bulan=${filter_bulan}&bulan_tahun=${filter_bulantahun}&tahun=${filter_tahun}&penjualan=${filter_penjualan}`;
