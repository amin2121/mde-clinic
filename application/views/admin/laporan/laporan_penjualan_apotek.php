...
<script type="text/javascript">
  ...
  function export_excel() {
      ...
      let link = `<?php echo base_url('laporan/penjualan_apotek/export_excel'); ?>?filter=${filter}&tgl_dari=${filter_dari}&tgl_sampai=${filter_sampai}&bulan=${filter_bulan}&bulan_tahun=${filter_bulantahun}&tahun=${filter_tahun}&id_cabang=${id_cabang}`;
