...
<body>
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <form action="<?= base_url() ?>laporan/faktur_barang/print_laporan" method="POST"
                    class="form-horizontal" target="_blank" autocomplete="off">
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <div class="col-sm-1">
                            <label class="radio-inline">
                              <input type="radio" name="filter" value="hari" id="filter_hari" class="styled"
                                checked="checked">
                              Hari
                            </label>
                          </div>
  ...
  <script type="text/javascript">
    ...
    function export_excel() {
      ...
      let link = `<?php echo base_url('laporan/faktur_barang/export_excel'); ?>?filter=${filter}&tanggal_dari=${filter_dari}&tgl_sampai=${filter_sampai}&bulan=${filter_bulan}&bulan_tahun=${filter_bulantahun}&tahun=${filter_tahun}`;
