			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					...
					<div class="heading-elements">
						<ul class="icons-list">
							<li><button class="btn btn-md btn-default" type="button" onclick="window.location.href='<?= base_url('apotek/barang_konsinyasi') ?>'"><i class="icon-arrow-left7"></i> Kembali</button></li>
						</ul>
					</div>
				</div>
						...
						<div class="col-sm-12">
							...
							<div class="tabbable">
								<ul class="nav nav-tabs nav-tabs-component">
									<li class="active"><a href="#detail-faktur" data-toggle="tab">Detail Konsinyasi</a></li>
								</ul>
									...
									<div class="tab-pane active" id="detail-faktur">
										<div class="table-responsive">
											<table class="table table-bordered table-striped" id="table-detail-faktur">
												...
												<tbody>
													<?php if (empty($detail_konsinyasi)): ?>
														<tr>
															<td colspan="8" class="text-center">Detail konsinyasi Kosong</td>
														</tr>
													<?php else: ?>
														<?php foreach ($detail_konsinyasi as $key => $df): ?>
															<tr>
																		...
																		<div class="modal-dialog">
																			<div class="modal-content">
																				...
																				<div class="modal-footer">
																					...
																					<a href="<?= base_url('apotek/barang_konsinyasi/hapus_detail_konsinyasi?id_konsinyasi='. $df['id_konsinyasi'].'&id_detail_konsinyasi='.$df['id']) ?>" class="btn btn-danger"><i class="icon-bin"></i> Hapus</a>
																					<!-- <a href="<= base_url('apotek/barang_konsinyasi/hapus_detail_konsinyasi?id_konsinyasi='. $df['id_konsinyasi'].'&id_konsinyasi='.$df['id']) ?>" class="btn btn-danger"><i class="icon-bin"></i> Hapus</a> -->
																				</div>
																			</div>
																		</div>
																	</div>
