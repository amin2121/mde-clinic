				...
				<div class="content">
								...
								<div class="col-sm-12">
									...
									<div class="tabbable">
										<ul class="nav nav-tabs nav-tabs-component">
											<li class="active"><a href="#faktur" data-toggle="tab">Barang konsinyasi</a></li>
											<li><a href="#tambah-faktur" data-toggle="tab">Tambah Konsiyasi</a></li>
										</ul>
										...
										<div class="tab-content">
											<div class="tab-pane active" id="faktur">
												...
												<div class="table-responsive">
													<table class="table table-bordered table-striped" id="table-faktur">
														...
														<th class="text-center">No Konsinyasi</th>
											...
											<div class="tab-pane" id="tambah-faktur">
												<form action="<?= base_url('apotek/barang_konsinyasi/tambah_konsinyasi') ?>"
													class="form-horizontal" method="POST" id="form-tambah-faktur">
													<fieldset class="content-group" style="margin-top: 2em !important;">
														<!-- radio no faktur -->
														<div class="form-group">
															<div class="col-sm-12">
																<label class="radio-inline">
																	<input type="radio" name="radio-no-faktur"
																		id="radio-no-faktur-default"
																		class="styled control-success" checked="checked"
																		onchange="onDefaultOrGenerateNoFaktur(this)">
																	<b>Default</b>
																</label>

																<label class="radio-inline">
																	<input type="radio" name="radio-no-faktur"
																		id="radio-no-faktur-generate"
														...
														<div class="form-group">	
															<label class="control-label col-sm-2"><b>No Konsinyasi</b></label>
															<div class="col-sm-10">
																<input type="text" class="form-control"
																	id="no-tambah-faktur" name="no_konsinyasi"
																	placeholder="No Konsinyasi">
															</div>
														</div>

														<div class="form-group">
															<label
																class="control-label col-sm-2"><b>Nama penitip</b></label>
															<div class="col-sm-10">
															<input type="text" class="form-control" id="no-tambah-faktur" name="nama_penitip" placeholder="Masukan Nama Penitip">
															<input type="hidden" class="form-control" id="kosninyasi" value="Konsinyasi" name="status">
															</div>
														</div>														
														<div class="form-group">
																...
																<tbody id="tbody-tambah-barang-faktur">
																	<tr style="cursor: pointer" id="row-faktur-1">
																				...
																				<div class="input-group">
																					<span class="input-group-btn">
																						<button
																							...
																							type="button"
																							onclick="get_barang(this, 1)"><i
																								class="icon-search4"></i></button>
																					</span>
																					<input type="text"
																						class="form-control" placeholder="Cari Barang Anda.." readonly
																						id="search-barang-faktur-1" name="nama_barang[]">
																					<input type="hidden" class="form-control" readonly id="kode-barang-faktur-1" name="kode_barang[]">
																				</div>
																			</div>
																		</td>
																		<td>
																		...
																		<td>
																			...
																			<div class="form-group">
																				<div class="input-group">
																					<span class="input-group-addon"><b>Rp.
																						</b></span>
																					<input type="text"
																						class="form-control rupiah"
																						id="harga-awal-faktur-1"
																						name="harga_awal[]"
																						onkeyup="hitung_total_harga_by_harga_awal(1)"
																		...
																		<td>
																			...
																			<div class="form-group">
																				<div class="input-group">
																					...
																					<input type="text"
																						class="form-control rupiah input-harga-jual"
																						id="harga-jual-faktur-1"
																						name="harga_jual[]"
																						onkeyup="hitung_total_harga_beli(1)"
																						placeholder="Konsinyasi"
																						>
																				</div>
																			</div>
																		</td>
																			...
																			<div class="form-group">
																				<div class="input-group">
																					...
																					<input type="text"
																						...
																						autocomplete="off"
																						id="input-tgl-kadaluarsa-tambah-faktur-1">
																				</div>
																			</div>
																			<!-- tanggal kadaluarsa -->
																		</td>
																						...
																						<div class="modal-body">
																							<div class="form-group">
																								<div
																									class="input-group">
																									<input type="text"
																										id="search-barang-in-modal-1"
																										placeholder="Cari Barang Yang Anda Inginkan..."
																										class="form-control"
																										onkeyup="cari_barang_in_modal(this.value, 1)">
																									<span
														...
														<input type="text" id="total_beli_1" hidden=""
															class="harga_total_beli">
														<button class="btn btn-md btn-warning" type="button"
															style="margin: 2em 0;" onclick="add_rows()"><i
																class="icon-plus3 position-left"></i> Tambah</button>
															...
															<div class="col-lg-10">
																<div class="input-group">
																	...
																	<input type="text" class="form-control rupiah"
																		id="total-harga-beli-faktur"
																		name="total_harga_beli" readonly="">
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-lg-10"><button
																	class="btn btn-md bg-success-600" type="button"
																	onclick="on_submit_tambah_faktur(this)"><i
					...
					<script>
						$(window).load(function () {
							...
							$.ajax({
								url: '<?= base_url('apotek/barang_konsinyasi/get_konsinyasi_ajax') ?>',
								method: 'GET',
								dataType: 'json',
								beforeSend: () => {
								...
								success: (res) => {
									...
									if (res.status) {
										...
										<tr>
											...
											<td class="text-center">${item.no_konsinyasi}</td>
											<td class="text-right"></i><b>Rp. </b>${NumberToMoney(item.total_harga_beli)}</td>
											<td class="text-center">${item.tipe_pembayaran}</td>
											<td>
												<div class="text-center">
													<a href="#" class="btn btn-xs btn-icon btn-primary" data-toggle="modal" data-target="#modal_ubah_${item.id}"><i class="icon-pencil position-left"></i> Edit</a>
													<a href="<?= base_url("apotek/barang_konsinyasi/detail_konsinyasi?id_konsinyasi=") ?>${item.id}" class="btn btn-xs btn-icon btn-info"><i class="icon-search4 position-left"></i> Detail</a>
												...
												<!-- Modal Ubah Faktur -->
												<div id="modal_ubah_${item.id}" class="modal fade">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<form action="<?= base_url('apotek/barang_konsinyasi/ubah_konsinyasi') ?>" method="POST">
															<div class="modal-body">
																<input type="text" value="${item.id}" name="id_konsinyasi" hidden>

																<div class="form-group">
																	<label class="control-label"><b>No Faktur</b></label>
																	<input type="text" class="form-control" name="no_konsinyasi" id="no-ubah-faktur-${item.id}" value="${item.no_konsinyasi}">
																</div>
																<div class="form-group">
																	<label class="control-label"><b>Nama Pentip</b></label>
																	<input type="text" class="form-control" name="nama_penitip" id="no-ubah-faktur-${item.id}" value="${item.nama_penitip}">
																</div>
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																<div class="alert alert-danger no-border">
																	<p>Apakah Anda Ingin <span class="text-semibold text-center">Menghapus</span> Faktur ${item.no_konsinyasi} ?</p>
																</div>
															</div>
															<div class="modal-footer">
																<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross position-left"></i> Keluar</button>
																<a href="<?= base_url('apotek/Barang_konsinyasi/hapus_konsinyasi?id_konsinyasi=') ?>${item.id}" class="btn btn-danger"><i class="icon-bin position-left"></i> Hapus</a>
															</div>
														</div>
													</div>
												</div>
					...
					`
						...
						function cari_faktur_by_tanggal() {
							...
							// $('#popup_load').show();
							$.ajax({
								url: '<?= base_url('apotek/barang_konsinyasi/cari_faktur_by_tanggal_ajax') ?>',
								...
								success: (res) => {
									...
									if (res.status) {
										...
										for (const item of res.data) {
											...
											<td class="text-center">${NumberToMoney(item.harga_awal)}</td>
											<td class="text-center">${NumberToMoney(item.harga_jual)}</td>
										</tr>
									`
										}
									} else {
					...
					`
						...
						function get_barang(e, no) {
							$.ajax({
								url: '<?= base_url('apotek/Barang_konsinyasi/get_nama_barang_ajax') ?>',
								method: 'POST',
								dataType: 'json',
								success: (res) => {
									console.log(res);
					...
					`
						...
						let onDefaultOrGenerateNoFaktur = (e) => {
							...
							if (e.id == "radio-no-faktur-generate") {
								...
								let today = new Date();
								let today_code = `${BK_letter}-${today.getFullYear()}${(today.getMonth() + 1)}${today.getDate()}${random_number}`;
						...
						let add_barang = (id_barang, row) => {
							...
							$.ajax({
								url: `<?= base_url('apotek/barang_konsinyasi/barang?id_barang=') ?>${id_barang}`,
								method: 'GET',
								dataType: 'json',
								success: (res) => {
								console.log(id_barang);
									...
									$(`#ppn-${row}`).val(res.data.ppn)
									$(`#presentase-${row}`).val(res.data.presentase)
									...
									$(`#laba-faktur-${row}`).val(convertRupiah(parseInt(res.data.laba)))
						...
						let hitung_total_harga_beli = (row) => {
							let unMaskInputpersentase = $(`#persentase-${row}`).unmask();
							let unMaskInputppn = $(`#ppn-${row}`).unmask();
							...
							let persentase = $(`#persentase-${row}`).val();
							let ppn = $(`#ppn-${row}`).val();
							...
							let hitunglaba = parseInt(hargaAwal) - parseInt(hargaJual);


							$(`#laba-faktur-${row}`).val(hitunglaba);
						...
						let hitung_total_harga_by_harga_awal = (row) => {
							if ($(`#harga-jual-faktur-${row}`).val() !== 0 || $(`#harga-jual-faktur-${row}`).val() !== "") {
								...
								let total_harga_beli = parseInt(jumlah_beli) * parseInt(hargaAwal);
								let hitung_laba = parseInt(hargaAwal) - parseInt(hargaJual);


								$(`#laba-faktur-${row}`).val(hitung_laba);
								$('#total-harga-beli-faktur').val(0);
						...
						let hitung_total_harga_by_jumlah_beli = (row) => {
							let inputpersentase = $(`#persentase-${row}`)
							let inputppn = $(`#ppn-${row}`)
							...
							if (inputHargaJual.val() !== 0 || inputHargaJual.val() !== "") {
								...
								let ppnNominal = parseInt(hargaAwal) * (parseInt(ppn) / 100);
								let hargaJualppn = parseInt(hargaAwal) + ppnNominal;
								let labaJual = parseInt(hargaJualppn) * (parseInt(persentase) / 100);
								let hargaDijual = parseInt(hargaJualppn) + parseInt(labaJual);

								$(`#harga-jual-faktur-${row}`).val(hargaDijual);
								$(`#laba-faktur-${row}`).val(labaJual);
											...
											<input type="text" name="id_barang[]" id="id-barang-${increment_row}" hidden>
												...
												<div class="form-group">
													<div class="input-group">
														...
														<input type="hidden" class="form-control" readonly id="kode-barang-faktur-${increment_row}" name="kode_barang[]">
														</div>
												</div>
											...
											<td>
												...
												<div class="form-group">
													<div class="input-group">
														...
														<input type="text" class="form-control rupiah" id="harga-awal-faktur-${increment_row}" name="harga_awal[]" onkeyup="hitung_total_harga_by_harga_awal(${increment_row})" placeholder="Harga awal">
													</div>
												</div>
											</td>
											<td>
												...
												<div class="form-group">
													<div class="input-group">
														<span class="input-group-addon"><b>Rp. </b></span>
														<input type="text" class="form-control rupiah input-harga-jual" id="harga-jual-faktur-${increment_row}" name="harga_jual[]" onkeyup="hitung_total_harga_beli(${increment_row})" placeholder="Konsinyasi">
													</div>
												</div>
											</td>
											<td>
											...
											<td>
												...
												<div class="form-group">
													<div class="input-group">
														...
														<input type="text" class="form-control datepicker" placeholder="tanggal" name="tanggal_kadaluarsa[]" id="input-tgl-kadaluarsa-tambah-faktur-${increment_row}">
													</div>
												</div>
												<!-- tanggal kadaluarsa -->
											</td>
