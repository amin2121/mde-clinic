			...
			<div class="content-wrapper">
				<div class="content">
									...
									<div class="tabbable">
										...
										<div class="tab-content">
													...
													<div class="row">
														<div class="col-sm-12">
															<div class="form-group">
																<label
																	class="control-label col-sm-1"><b>Tanggal</b></label>
																<div class="col-sm-11">
																	<input type="text" class="form-control input-tgl"
																		autocomplete="off" name="tgl_dari"
																		id="input-tgl">
																</div>
															</div>
															<div class="col-sm-12">
																<button class="btn btn-md btn-primary" type="button"
																	onclick="cari_faktur_by_tanggal()"><i
																		class="icon-search4 position-left"></i>
																	Cari</button>
																<button class="btn btn-md btn-success" type="button"
																	onclick="cari_faktur_by_tanggal()"><i
																		class="icon-book2 position-left"></i> Lihat
																	Semua</button>
															</div>
														</div>
													</div>
											...
											<div class="tab-pane" id="tambah-faktur">
												<form action="<?= base_url('farmasi/faktur/tambah_faktur') ?>"
																...
																<tbody id="tbody-tambah-barang-faktur">
																	<tr style="cursor: pointer" id="row-faktur-1">
																		...
																		<td>
																			<!-- jumlah beli -->
																			<div class="form-group">
																				<input type="text" class="form-control"id="jumlah-beli-faktur-1" name="jumlah_beli[]" autocomplete="off" onkeyup="hitung_total_harga_by_jumlah_beli(1)">
																			</div>
																		</td>
																		<td>
																			<!-- PPN -->
																			<div class="form-group">
																				<div class="input-group">
																					...
																					<input type="text"
																						class="form-control rupiah inputppn"
																						id="ppn-1" name="ppn[]"
																						autocomplete="off"
																						onkeyup="hitung_harga_by_presentase(1)"
																						placeholder="PPN">
																				</div>
																			</div>
																		</td>
																		<td>
																			...
																			<div class="form-group">
																				<div class="input-group">
																					...
																					<input type="text"
																						class="form-control rupiah input-persentase"
																						id="persentase-1"
																						name="persentase[]"
																						autocomplete="off"
																						onkeyup="hitung_harga_by_presentase(1)"
					...
					<script>
						$(window).load(function () {
							...
							<tr>
								...
								<td class="text-center">${item.no_faktur ? item.no_faktur : '-'}</td>
								<td class="text-center">
									<span><i class="icon-calendar" style="margin-right: 5px !important;"></i> ${date_indonesian(new Date(item.created_at))}</span>
								</td>
								<td class="text-left"></i><b>Rp. </b>${NumberToMoney(item.total_harga_beli)}</td>
					...
					`
						...
						let hitung_harga_by_presentase = (row) => {
							let unMaskInputpersentase = $(`#persentase-${row}`).unmask();
							let unMaskInputppn = $(`#ppn-${row}`).unmask();
							let unMaskInputHargaAwal = $(`#harga-awal-faktur-${row}`).unmask();
							let unMaskInputHargaJual = $(`#harga-jual-faktur-${row}`).unmask();
			...
			<td>
				...
				<td>
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><b>Rp. </b></span>
							<input type="text" class="form-control rupiah input-harga-jual" id="harga-jual-faktur-${increment_row}" readonly name="harga_jual[]" onkeyup="hitung_total_harga_beli(${increment_row})">
						</div>
					</div>
				</td>
				<td>
