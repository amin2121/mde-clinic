	...
	public function export_excel()
	{
		...
		if ($filter == 'hari') {
			...
			foreach ($res_tanggal as $title) {
				...
				$sheet->getStyle('A8:G8')->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
				...
				foreach ($res_tanggal as $result) {
					...
					$sheet->setCellValue('D' . $row, ($row_masuk['jumlah'] == 0) ? "-" : number_format((int) $row_masuk['jumlah']));
					$sheet->setCellValue('E' . $row, ($row_masuk['nilai'] == 0) ? "-" : number_format((int) $row_masuk['nilai']));
					$sheet->setCellValue('F' . $row, ($row_keluar['jumlah'] == 0) ? "-" : number_format((int) $row_keluar['jumlah']));
					$sheet->setCellValue('G' . $row, ($row_keluar['nilai'] == 0) ? "-" : number_format((int) $row_keluar['nilai']));
			...
			$file_name = 'laporan_keluar_masuk_stok.xlsx';
